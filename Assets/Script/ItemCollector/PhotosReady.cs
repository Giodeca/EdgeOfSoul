...
public class PhotosReady : ItemCollector
{
    ...
    [SerializeField] private GameObject PhotoOutputParent;
    ...
    private void Update()
    {
        ...
        {
            PhotoGraphIstantiate();
        }
    }
    // This method captures the photograph of the objects
    public void PhotoGraphIstantiate()
    {
        ...
        GameObject objectToSpawn = Instantiate(PhotoOutputParent, transform.position, transform.rotation);
